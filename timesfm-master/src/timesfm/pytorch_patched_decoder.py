...
class PatchedTimeSeriesDecoder(nn.Module):
  ...
  def decode(
    ...
    print('\r', f'[PatchedTimeSeriesDecoder] decode, input_ts.shape = {input_ts.shape}, output_patch_len = {output_patch_len}, num_decode_patches = {num_decode_patches}, horizon_len = {horizon_len}', end = '\n', flush=False)
